...
package com.robo.temi;
import androidx.appcompat.app.AppCompatActivity;
public class TemiMainActivity extends AppCompatActivity {
...
public class TemiMainActivity extends AppCompatActivity implements
        Robot.NlpListener,
...
/**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        printLog("inside oncreate", "inside oncreate method");
...
/*public void savedLocationsDialog(View view) {
        ...
        mAdapter = new CustomAdapter(TemiMainActivity.this, android.R.layout.simple_selectable_list_item, locations);
        AlertDialog.Builder versionsDialog = new AlertDialog.Builder(TemiMainActivity.this);
        ...
        dialog.getListView().setOnItemClickListener((parent, view1, position, id) -> {
            final AlertDialog.Builder builder = new AlertDialog.Builder(TemiMainActivity.this);
...
/**
    ...
    public void onNlpCompleted(NlpResult nlpResult) {
        ...
        Toast.makeText(TemiMainActivity.this, nlpResult.action, Toast.LENGTH_SHORT).show();
